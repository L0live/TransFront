...
export default function Home(): HTMLElement {
  ...
  const createInput = (placeholder: string, type: string): HTMLInputElement => {
  ...
  nickWrapper.appendChild(createInput('Enter your nickname', 'text'));
  ...
  passWrapper.appendChild(createInput('Enter your password', 'password'));
  ...
  loginRegisterWrapper.appendChild(createLoginRegisterButton('Register->', () => navigate('/')));
